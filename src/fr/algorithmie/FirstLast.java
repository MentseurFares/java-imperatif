...
public class FirstLast {
	...
	public static void main(String[] args) {
		// C'est plus simple avec une methode et faire plusieurs appel avec plusieur
		// tableaux :D
...
//		int[] array1 = new int[0];			  // un test pour donner un false 
		...
		System.out.println("array n'est pas vide et son premier element est egal au dernier element : " + stateOfArray);
	}
